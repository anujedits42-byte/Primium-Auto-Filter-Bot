...
<blockquote>🌿 ᴍᴀɪɴᴛᴀɪɴᴇᴅ ʙʏ : <a href='https://t.me/Satyajeetkumarofficial'>Satyajeet Kumar &lt;/&gt;</a></b></blockquote>"""

    ABOUT_TEXT = """<blockquote><b>‣ ᴍʏ ɴᴀᴍᴇ : Pro Search Bot
‣ ᴄʀᴇᴀᴛᴏʀ : <a href='https://t.me/Satyajeetkumarofficial'>Satyajeet Kumar</a>
‣ 𝙳𝚎𝚟𝚕𝚘𝚙𝚎𝚛 : <a href='https://t.me/BOT_OWNER26'>𝖠ᴍᴀɴ 𝖣ᴇᴠᴇʟᴏᴘᴇʀ</a>
‣ 𝐏𝐨𝐰𝐞𝐫𝐞𝐝 𝐁𝐲 : <a href='https://t.me/ProXBotz'>𝐏𝐫𝐨𝐗𝐁𝐨𝐭𝐳</a>
‣ ʟɪʙʀᴀʀʏ : ᴘʏʀᴏɢʀᴀᴍ
‣ ʟᴀɴɢᴜᴀɢᴇ : ᴘʏᴛʜᴏɴ
‣ ᴅᴀᴛᴀ ʙᴀsᴇ : ᴍᴏɴɢᴏ ᴅʙ
‣ ʜᴏsᴛᴇᴅ ᴏɴ  :  ᴡᴇʙ
...
If there is an error, ask in the support group @ProBotXUpdate</b>"""
...
<code>/set_tutorial https://t.me/ProBotXUpdate</code>

<code>/set_tutorial_2 https://t.me/ProBotXUpdate</code>

<code>/set_tutorial_3 https://t.me/ProBotXUpdate</code>
...
🏆 ɪꜰ ʏᴏᴜ ᴡᴀɴᴛ ᴀ ɴᴇᴡ ᴘʟᴀɴ ᴀᴘᴀʀᴛ ꜰʀᴏᴍ ᴛʜᴇ ɢɪᴠᴇɴ ᴘʟᴀɴ, ᴛʜᴇɴ ʏᴏᴜ ᴄᴀɴ ᴛᴀʟᴋ ᴛᴏ ᴏᴜʀ <a href='https://telegram.dog/Satyajeetkumarofficial'>ᴏᴡɴᴇʀ</a> ᴅɪʀᴇᴄᴛʟʏ ʙʏ ᴄʟɪᴄᴋɪɴɢ ᴏɴ ᴛʜᴇ ᴄᴏɴᴛᴀᴄᴛ ʙᴜᴛᴛᴏɴ ɢɪᴠᴇɴ ʙᴇʟᴏᴡ.
...
--------------Set Ads----------------
➩ /set_ads {ads name}#{Times}#{photo URL} - <a href="https://t.me/ProBotXUpdate">Explain</a>
➩ /del_ads - Delete ads
-------------Top Trending------------
➩ /setlist {Mirzapur, Money Heist} - <a href="https://t.me/ProBotXUpdate">Explain</a>
...
--------------Verify On Off------------
/verifyoff - off verification <a href="https://telegram.dog/Satyajeetkumarofficial">Cᴏɴᴛᴀᴄᴛ</a> ᴛʜᴇ ʙᴏᴛ ᴀᴅᴍɪɴ ғᴏʀ ᴀ ᴠᴇʀɪғʏ.ᴏғғ
/verifyon - on verification 
------------Set File Caption-----------
/set_caption - set coustom file caption 
-----------Set Imdb Template-----------
/set_template - set IMDb template <a href="https://t.me/ProBotXUpdate">Example</a>
--------------Set Tutorial-------------
...
Iғ ʏᴏᴜ ʜᴀᴠᴇ ᴀɴʏ ᴅᴏᴜʙᴛs ᴘʟᴇᴀsᴇ <a href="https://t.me/satyajeetkumarofficial">ᴄᴏɴᴛᴀᴄᴛ</a> ᴍʏ <a href="https://telegram.dog/Satyajeetkumarofficial">sᴀᴛʏᴀᴊᴇᴇᴛ ᴋᴜᴍᴀʀ</a></b>"""
